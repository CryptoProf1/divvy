...
const string strMessageMagic = "Divvy Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (nHeight > 40 && nHeight <= 70) {
        nSubsidy = 0 * COIN; // premine to be confirmed
    }
    else if (nHeight > 70 && nHeight <= 100) {
        nSubsidy = 1 * COIN; // instamine prevention
    }
    else if (nHeight > 100 && nHeight <= 10000) {
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 > 100 && pindexBest->nHeight+1 <= 10000) {
        nSubsidy = 10 * COIN;
    }
    else if (pindexBest->nHeight+1 > 10000 && pindexBest->nHeight+1 <= 20000)  {
        nSubsidy = 12 * COIN;
    }
    else if (pindexBest->nHeight+1 > 20000 && pindexBest->nHeight+1 <= 30000)  {
        nSubsidy = 13 * COIN;
    }
    else if (pindexBest->nHeight+1 > 30000 && pindexBest->nHeight+1 <= 40000) {
        nSubsidy = 14 * COIN;
    }
    else if (pindexBest->nHeight+1 > 40000 && pindexBest->nHeight+1 <= 50000) {
        nSubsidy = 15 * COIN;
    }
