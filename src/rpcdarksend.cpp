...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw runtime_error(
                ...
                "  stop         - Stop masternode configured in owncoin.conf\n"
                ...
                "  vote         - Vote on a owncoin initiative\n"
                );
    ...
    if (strCommand == "genkey")
    {
        ...
        return CowncoincoinSecret(secret).ToString();
    }
...
Value masternodelist(const Array& params, bool fHelp)
{
                ...
                && strMode != "pubkey" && strMode != "rank" && strMode != "status" && strMode != "addr" && strMode != "votes" && strMode != "lastpaid"))
    {
        throw runtime_error(
                ...
                "  votes          - Print all masternode votes for a owncoin initiative (can be additionally filtered, partial match)\n"
