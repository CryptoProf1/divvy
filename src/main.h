...
#define START_MASTERNODE_PAYMENTS_TESTNET 1514246400
#define START_MASTERNODE_PAYMENTS 1514246400

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 1 DVY per COIN i.e. 8%
