...
int nAnonymizeDivvyAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Divvy
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Divvy
    // Mac: ~/Library/Application Support/Divvy
    // Unix: ~/.divvy
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Divvy";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "divvy.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "divvyd.pid"));
